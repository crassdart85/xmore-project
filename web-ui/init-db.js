...
async function initializeDatabase() {
  ...
  try {
    ...
    // Table: Time Machine backtest simulation cache
    console.log('📊 Creating backtest_simulations table...');
    await pool.query(`
    ...
    `);
    await pool.query('CREATE INDEX IF NOT EXISTS idx_backtest_created ON backtest_simulations(created_at DESC)');
    await pool.query('CREATE INDEX IF NOT EXISTS idx_backtest_lookup ON backtest_simulations(input_amount, start_date)');
